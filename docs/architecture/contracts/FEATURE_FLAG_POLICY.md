...
| `license_runtime_enforcement` | compatibility/release | Gate future runtime-license-related behavior after design approval. This must not implement Phase 7B by itself. | `false` |
